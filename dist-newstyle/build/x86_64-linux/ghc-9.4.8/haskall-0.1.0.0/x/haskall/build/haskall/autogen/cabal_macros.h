...
/* package haskall-0.1.0.0 */
#ifndef VERSION_haskall
#define VERSION_haskall "0.1.0.0"
#endif /* VERSION_haskall */
#ifndef MIN_VERSION_haskall
#define MIN_VERSION_haskall(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskall */
...
#define CURRENT_COMPONENT_ID "haskall-0.1.0.0-inplace-haskall"
